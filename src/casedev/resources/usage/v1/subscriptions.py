...
from ....types.usage.v1 import subscription_test_params, subscription_create_params, subscription_update_params
...
class SubscriptionsResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._patch(
            path_template("/usage/v1/subscriptions/{subscription_id}", subscription_id=subscription_id),
            body=maybe_transform(
                {
                    "callback_url": callback_url,
    ...
    def test(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._post(
            path_template("/usage/v1/subscriptions/{subscription_id}/test", subscription_id=subscription_id),
            body=maybe_transform(
                {
