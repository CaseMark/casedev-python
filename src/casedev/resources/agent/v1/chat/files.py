...
from .....types.agent.v1.chat.file_list_response import FileListResponse
...
class FilesResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        """Lists files created by the agent in the sandbox workspace.
    ...
    def download(
        ...
        *,
        ...
        """Downloads a file from the sandbox workspace by path.
