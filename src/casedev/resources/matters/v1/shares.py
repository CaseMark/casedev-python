...
from ....types.matters.v1 import share_create_params
...
class SharesResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        permission: Literal["read", "edit"] | Omit = omit,
        ...
        return self._post(
            path_template("/matters/v1/{id}/shares", id=id),
    ...
    def list(
        ...
        *,
        ...
        """List cross-org shares for a matter.
    ...
    def delete(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._delete(
            path_template("/matters/v1/{id}/shares/{share_id}", id=id, share_id=share_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
