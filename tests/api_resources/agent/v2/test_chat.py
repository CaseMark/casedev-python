...
class TestChat:
    ...
    def test_raw_response_create(self, client: Casedev) -> None:
        response = client.agent.v2.chat.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: Casedev) -> None:
        with client.agent.v2.chat.with_streaming_response.create() as response:
    ...
    def test_method_delete(self, client: Casedev) -> None:
        chat = client.agent.v2.chat.delete(
            "id",
        )
    ...
    def test_raw_response_delete(self, client: Casedev) -> None:
        response = client.agent.v2.chat.with_raw_response.delete(
            "id",
        )
    ...
    def test_streaming_response_delete(self, client: Casedev) -> None:
        with client.agent.v2.chat.with_streaming_response.delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: Casedev) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.agent.v2.chat.with_raw_response.delete(
                "",
            )

    @parametrize
    def test_method_cancel(self, client: Casedev) -> None:
        chat = client.agent.v2.chat.cancel(
            "id",
        )
    ...
    def test_raw_response_cancel(self, client: Casedev) -> None:
        response = client.agent.v2.chat.with_raw_response.cancel(
            "id",
        )
    ...
    def test_streaming_response_cancel(self, client: Casedev) -> None:
        with client.agent.v2.chat.with_streaming_response.cancel(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_reply_to_question(self, client: Casedev) -> None:
        chat = client.agent.v2.chat.reply_to_question(
    ...
    def test_raw_response_reply_to_question(self, client: Casedev) -> None:
        response = client.agent.v2.chat.with_raw_response.reply_to_question(
            request_id="requestID",
            id="id",
            answers=[["string"]],
        )
    ...
    def test_streaming_response_reply_to_question(self, client: Casedev) -> None:
        with client.agent.v2.chat.with_streaming_response.reply_to_question(
            request_id="requestID",
            id="id",
            answers=[["string"]],
        ) as response:
    ...
    def test_path_params_reply_to_question(self, client: Casedev) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.agent.v2.chat.with_raw_response.reply_to_question(
                request_id="requestID",
                id="",
                answers=[["string"]],
            )
    ...
    def test_raw_response_respond(self, client: Casedev) -> None:
        response = client.agent.v2.chat.with_raw_response.respond(
            id="id",
        )
    ...
    def test_streaming_response_respond(self, client: Casedev) -> None:
        with client.agent.v2.chat.with_streaming_response.respond(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_respond(self, client: Casedev) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.agent.v2.chat.with_raw_response.respond(
                id="",
            )
    ...
    def test_raw_response_send_message(self, client: Casedev) -> None:
        response = client.agent.v2.chat.with_raw_response.send_message(
            id="id",
        )
    ...
    def test_streaming_response_send_message(self, client: Casedev) -> None:
        with client.agent.v2.chat.with_streaming_response.send_message(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_send_message(self, client: Casedev) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.agent.v2.chat.with_raw_response.send_message(
                id="",
            )
    ...
    def test_raw_response_stream(self, client: Casedev) -> None:
        response = client.agent.v2.chat.with_raw_response.stream(
            id="id",
        )
    ...
    def test_streaming_response_stream(self, client: Casedev) -> None:
        with client.agent.v2.chat.with_streaming_response.stream(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_stream(self, client: Casedev) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.agent.v2.chat.with_raw_response.stream(
                id="",
            )
...
class TestAsyncChat:
    ...
    async def test_raw_response_create(self, async_client: AsyncCasedev) -> None:
        response = await async_client.agent.v2.chat.with_raw_response.create()
    ...
    async def test_streaming_response_create(self, async_client: AsyncCasedev) -> None:
        async with async_client.agent.v2.chat.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncCasedev) -> None:
        chat = await async_client.agent.v2.chat.delete(
            "id",
        )
        assert_matches_type(ChatDeleteResponse, chat, path=["response"])
    ...
    async def test_raw_response_delete(self, async_client: AsyncCasedev) -> None:
        response = await async_client.agent.v2.chat.with_raw_response.delete(
            "id",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncCasedev) -> None:
        async with async_client.agent.v2.chat.with_streaming_response.delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncCasedev) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.agent.v2.chat.with_raw_response.delete(
                "",
            )

    @parametrize
    async def test_method_cancel(self, async_client: AsyncCasedev) -> None:
        chat = await async_client.agent.v2.chat.cancel(
            "id",
        )
        assert_matches_type(ChatCancelResponse, chat, path=["response"])
    ...
    async def test_raw_response_cancel(self, async_client: AsyncCasedev) -> None:
        response = await async_client.agent.v2.chat.with_raw_response.cancel(
            "id",
        )
    ...
    async def test_streaming_response_cancel(self, async_client: AsyncCasedev) -> None:
        async with async_client.agent.v2.chat.with_streaming_response.cancel(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_reply_to_question(self, async_client: AsyncCasedev) -> None:
        chat = await async_client.agent.v2.chat.reply_to_question(
            request_id="requestID",
            id="id",
            answers=[["string"]],
        )
    ...
    async def test_raw_response_reply_to_question(self, async_client: AsyncCasedev) -> None:
        response = await async_client.agent.v2.chat.with_raw_response.reply_to_question(
            request_id="requestID",
            id="id",
            answers=[["string"]],
        )
    ...
    async def test_streaming_response_reply_to_question(self, async_client: AsyncCasedev) -> None:
        async with async_client.agent.v2.chat.with_streaming_response.reply_to_question(
            request_id="requestID",
            id="id",
            answers=[["string"]],
        ) as response:
    ...
    async def test_path_params_reply_to_question(self, async_client: AsyncCasedev) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.agent.v2.chat.with_raw_response.reply_to_question(
                request_id="requestID",
                id="",
                answers=[["string"]],
            )
    ...
    async def test_raw_response_respond(self, async_client: AsyncCasedev) -> None:
        response = await async_client.agent.v2.chat.with_raw_response.respond(
            id="id",
        )
    ...
    async def test_streaming_response_respond(self, async_client: AsyncCasedev) -> None:
        async with async_client.agent.v2.chat.with_streaming_response.respond(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_respond(self, async_client: AsyncCasedev) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.agent.v2.chat.with_raw_response.respond(
                id="",
            )
    ...
    async def test_raw_response_send_message(self, async_client: AsyncCasedev) -> None:
        response = await async_client.agent.v2.chat.with_raw_response.send_message(
            id="id",
        )
    ...
    async def test_streaming_response_send_message(self, async_client: AsyncCasedev) -> None:
        async with async_client.agent.v2.chat.with_streaming_response.send_message(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_send_message(self, async_client: AsyncCasedev) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.agent.v2.chat.with_raw_response.send_message(
                id="",
            )
    ...
    async def test_raw_response_stream(self, async_client: AsyncCasedev) -> None:
        response = await async_client.agent.v2.chat.with_raw_response.stream(
            id="id",
        )
    ...
    async def test_streaming_response_stream(self, async_client: AsyncCasedev) -> None:
        async with async_client.agent.v2.chat.with_streaming_response.stream(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_stream(self, async_client: AsyncCasedev) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.agent.v2.chat.with_raw_response.stream(
                id="",
            )
