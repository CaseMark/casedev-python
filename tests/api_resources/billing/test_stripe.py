...
class TestStripe:
    ...
    @parametrize
    def test_method_handle_webhook(self, client: Casemark) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_handle_webhook(self, client: Casemark) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_handle_webhook(self, client: Casemark) -> None:
...
class TestAsyncStripe:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_handle_webhook(self, async_client: AsyncCasemark) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_handle_webhook(self, async_client: AsyncCasemark) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_handle_webhook(self, async_client: AsyncCasemark) -> None:
