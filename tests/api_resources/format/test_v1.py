...
class TestV1:
    ...
    @parametrize
    def test_method_create_document(self, client: Router) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_create_document(self, client: Router) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_create_document(self, client: Router) -> None:
...
class TestAsyncV1:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_create_document(self, async_client: AsyncRouter) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_create_document(self, async_client: AsyncRouter) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_create_document(self, async_client: AsyncRouter) -> None:
